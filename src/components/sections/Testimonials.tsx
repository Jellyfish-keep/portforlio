...
const testimonialsData = [
  { quote: "He automated our entire CI/CD pipeline with AI-driven optimizations — deployment speed doubled and failures dropped instantly.", name: "Michael Turner", title: "Brightwave Marketing Inc" },
  { quote: "The monitoring system he built predicts issues before they hit production. We’ve never had this level of stability.", name: "Rebecca Collins", title: "LumaTech Systems" },
  { quote: "His mix of DevOps engineering and AI insight cut our cloud costs while boosting performance. Total game-changer for our team.", name: "Jason Whitmore", title: "NorthPeak Digital" },
];
