...
export default function Contact() {
  ...
  useEffect(() => {
    const updateTimes = () => {
      ...
      const myDate = new Date(now.toLocaleString('en-US', { timeZone: 'America/Chicago' }));
    ...
    <section id="contact" ref={sectionRef} className="relative min-h-screen py-32 px-4 sm:px-6 lg:px-8" data-force-hide-cursor>
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-20">
          ...
          <p className="contact-header-reveal text-lg text-secondary max-w-3xl mx-auto">Got an idea you want to bring to life or a problem that needs a developer’s touch? I’m here to listen. Let’s transform your concept into a fast, secure, and fully functional software solution.</p>
        </div>
          ...
          <div className="flex flex-col gap-12">
            <div className="contact-content-reveal">
              ...
              <div className="p-6 bg-surface/50 backdrop-blur-lg border border-secondary/10 rounded-lg space-y-5">
                ...
                <div className="flex justify-between items-baseline border-t border-secondary/10 pt-4"><span className="text-primary font-medium">My Local Time (US)</span><time className="font-mono text-lg text-accent tracking-wider">{myTime}</time></div>
