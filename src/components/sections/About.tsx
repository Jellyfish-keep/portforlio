...
const vercelStackData = [
  { id: 'frontend', name: 'Frontend', icon: <Layers size={22} />, technologies: ['React Native', 'Vue.js', 'Next.js', 'TypeScript', 'JavaScript'], description: 'Crafting responsive, high-performance user interfaces with a focus on exceptional UX. Utilizing the power of React server components for speed and SEO.' },
  { id: 'backend', name: 'Backend & Data', icon: <Database size={22} />, technologies: ['Node.js', 'Express.js', 'FastAPI', 'MySQL/PostgreSQL'], description: 'Building robust, scalable server-side logic and database schemas. Leveraging serverless functions for efficiency and infinite scalability.' },
  { id: 'deployment', name: 'DevOps & AI', icon: <Cloud size={22} />, technologies: ['Docker', 'CI/CD Pipelines', 'Server Automation', 'Cloud Deployment', 'AI integration', 'Automation Systems', 'Python Tooling'], description: 'Deliver fully automated environments where AI handles testing, scaling, monitoring, and operational workflows.' },
];

const promises = [
  { title: "Intelligent Architecture", description: "Scalable, future-proof systems engineered to handle real-world growth without breaking a sweat.", icon: <CheckCircle className="text-accent flex-shrink-0 mt-1" size={24} /> },
  { title: "Code That Performs", description: "Clean, optimized, and reliable code that delivers speed, stability, and long-term maintainability.", icon: <CheckCircle className="text-accent flex-shrink-0 mt-1" size={24} /> },
  { title: "AI-Driven Efficiency", description: "Smart automation and machine-learning integrations that turn manual workflows into self-running systems.", icon: <CheckCircle className="text-accent flex-shrink-0 mt-1" size={24} /> },
  { title: "Delivery You Can Trust", description: "Clear timelines, consistent communication, and results delivered exactly as promised.", icon: <CheckCircle className="text-accent flex-shrink-0 mt-1" size={24} /> },
];
          ...
          <div ref={leftColRef} className="relative">
            <div className="space-y-24">
              <div className="narrative-block relative pl-10">
                ...
                <p className="text-secondary text-lg" data-cursor-text>Experienced in Python, JavaScript, Node.js, SQL, MongoDB, and API development. I build backend systems, full-stack apps, and AI-powered tools.</p>
              </div>
              <div className="narrative-block relative pl-10">
                <div className="narrative-line absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-accent/50 to-transparent origin-top" />
                <h3 className="text-3xl font-bold tracking-tighter mb-6" data-cursor-text>About Me</h3>
                <p className="text-secondary text-lg" data-cursor-text>I’m a software and AI developer with years of experience creating reliable, scalable web applications and automation solutions. I focus on clean code and practical results.</p>
              </div>
              <div className="narrative-block relative pl-10">
                <div className="narrative-line absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-accent/50 to-transparent origin-top" />
                <h3 className="text-3xl font-bold tracking-tighter mb-6" data-cursor-text>My Philosophy</h3>
                <p className="text-secondary text-lg" data-cursor-text>Work smart, keep learning, and deliver real value. I aim to build simple, effective solutions that help people and businesses succeed.</p>
              </div>
            </div>
          </div>
