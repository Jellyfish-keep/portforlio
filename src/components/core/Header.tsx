...
// --- Configuration ---
const ZAIN_TIMEZONE = 'America/Chicago';
const SECTIONS = [
...
useEffect(() => {
  const updateTimes = () => {
    ...
    const zainDate = new Date(
      new Date(now.toLocaleString('en-US', { timeZone: ZAIN_TIMEZONE })).getTime()
      + 60 * 60 * 1000 // +1 hour
    );
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-6 text-sm">
          <div className="text-center">
            <p className="text-xs text-secondary tracking-widest">TIME (CLIENT / ME)</p>
